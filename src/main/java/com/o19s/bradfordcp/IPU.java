...
public class IPU
{
  ...
  public static void main(String[] args)
  {
    if (args.length == 3) {
      ...
      String column_family = args[2];

      // Cleanup filename generated by the snapshot
//      cleanupSnapshotFilenames(args[0] + File.separator + keyspace + File.separator + column_family);

      // Perform the upgrade
      upgrade(keyspace, column_family);
    } else {
      System.err.println("Invalid parameter count");
      System.err.println("Usage: java -jar ipu-1.0-SNAPSHOT.jar -Dcassandra.config=file:///Users/cbradford/src/ipu/cassandra.yaml -Dcassandra.storagedir=file:///Users/cbradford/src/ipu/data /opt/ipu/data keyspace column_family");
    }
  }
}
